...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Updated to Teal Stem (#159F9A) */}
    <path d="M24 4C12.95 4 4 12.95 4 24C4 35.05 12.95 44 24 44C35.05 44 44 35.05 44 24C44 12.95 35.05 4 24 4Z" fill="#159F9A"/>
    <path d="M24 10C19.58 10 16 13.58 16 18C16 22.42 19.58 26 24 26C28.42 26 32 22.42 32 18C32 13.58 28.42 10 24 10ZM24 38C17.37 38 12 32.63 12 26H16C16 30.42 19.58 34 24 34C28.42 34 32 30.42 32 26H36C36 32.63 30.63 38 24 38Z" fill="white"/>
  </svg>
);

// ... rest of the icons remain unchanged as they take currentColor or className
export const ShortResponseIcon: React.FC<IconProps> = ({ className }) => (
...
export const LongResponseIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 6h7" />
    <path d="M4 12h7" />
    <path d="M4 18h7" />
...
export const WeFloraAskIcon: React.FC<IconProps> = ({ className }) => (
...
export const FlowerIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    ...
    <circle cx="12" cy="4.5" r="3" fill="currentColor" />
    <circle cx="12" cy="19.5" r="3" fill="currentColor" />
    <circle cx="4.5" cy="12" r="3" fill="currentColor" />
    <circle cx="19.5" cy="12" r="3" fill="currentColor" />
  </svg>
);
...
export const LockClosedIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 0-2-2H6a2 2 0 0-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
  </svg>
);
...
export const FilePdfIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
        <polyline points="14 2 14 8 20 8"></polyline>
        <path d="M10 12v-1a2 2 0 0 1 2-2h1"></path><path d="M14 12v1a2 2 0 0 1-2 2h-1"></path>
        <path d="M4 12h2"></path><path d="M4 18h2"></path><path d="M18 12h2"></path>
    </svg>
);

export const FileSheetIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
        <polyline points="14 2 14 8 20 8"></polyline>
        <path d="M8 12h8"></path><path d="M8 16h8"></path><path d="M12 8v8"></path>
    </svg>
);
...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 5a3 3 0 1 0-5.993.129"></path><path d="M18 7a3 3 0 1 0-3-4.583"></path>
        <path d="M12 19a3 3 0 1 0-5.993-.129"></path><path d="M18 17a3 3 0 1 0-3 4.583"></path>
        <path d="M12 12a3 3 0 1 0-3 4.583"></path><path d="M15 7.417a3 3 0 1 0-3-4.583"></path>
        <path d="M9.007 12.129A3 3 0 1 0 12 17"></path><path d="M14.993 12.129A3 3 0 1 0 12 7"></path>
        <path d="m14.5 10.5 1-1"></path><path d="m9.5 14.5 1-1"></path><path d="m14.5 14.5-1-1"></path>
        <path d="m9.5 10.5 1 1"></path>
    </svg>
);
...
export const TelescopeIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m6 21-3.1-3.1"></path><path d="m8 21-3.1-3.1"></path>
        <path d="m10 21-3.1-3.1"></path><path d="m12 21-3.1-3.1"></path>
        <path d="M16 11 8 3"></path><path d="m14 3-2.1 2.1"></path>
        <path d="m18 13-2.1 2.1"></path><path d="m20 5-2.1 2.1"></path>
        <path d="m22 7-2.1 2.1"></path><path d="m11 16 3 3"></path>
    </svg>
);
...
export const StarFilledIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.539 1.118l-3.975-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.783.57-1.838-.196-1.539-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
    </svg>
);
...
export const TableIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        {/* Simplified 2x2 grid representing a worksheet/table */}
...
export const SidebarCloseIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SidebarOpenIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect width="18" height="18" x="3" y="3" rx="2" ry="2"></rect>
        <line x1="9" x2="9" y1="3" y2="21"></line>
        <path d="m12 15 3-3-3-3"></path>
...
export const MergeCellsIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M3 8h18" />
    <path d="M3 16h18" />
    <rect x="7" y="7" width="10" height="10" stroke="none" fill="currentColor" fillOpacity="0.2" />
    <path d="M10 12h4" />
    <path d="M10 12l-1 1" />
    <path d="M10 12l-1-1" />
    <path d="M14 12l1 1" />
...
export const AdjustmentsHorizontalIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0h-3.75M3 12h3.75m16.5 0h-3.75M12 12h8.25m-8.25 0a1.5 1.5 0 11-3 0m3 0H6.75m12 6h3.75m-3.75 0a1.5 1.5 0 11-3 0m3 0H3.75" />
    </svg>
);

export const LeafIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.5 2 8 0 5.5-4.5 10-10 10Z"></path>
...
export const RulerIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m14.5 12.5 2-2"></path><path d="m11.5 9.5 2-2"></path><path d="m8.5 6.5 2-2"></path><path d="m17.5 15.5 2-2"></path>
    </svg>
);
...
export const PinFilledIcon: React.FC<IconProps> = ({ className }) => (
